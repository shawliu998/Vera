...
export const templates: TemplateDefinition[] = [
  ...
  },
  {
    ...
    maturity: "local_workflow_preview",
  },
  {
    ...
    steps: [
      {
        ...
        name: "Matter Intake",
        description:
          "Normalize matter profile, objectives, known parties, and document inventory.",
        status: "completed",
        riskLevel: "medium",
      },
      {
        ...
        description:
          "Extract dated events from agreement, payment record, email chain, and demand letter.",
        status: "completed",
        riskLevel: "medium",
      },
      {
        ...
        name: "Issue Spotting",
        description:
          "Identify breach, damages, notice, cure, and evidence sufficiency issues.",
        status: "completed",
        riskLevel: "high",
      },
      {
        ...
        description:
          "Map each claim to supporting, contradicting, or insufficient evidence.",
        status: "completed",
        riskLevel: "high",
      },
      {
        ...
        description:
          "Draft a structured memo with caveats, missing materials, and review notes.",
        status: "needs_review",
        riskLevel: "high",
      },
    ],
  ...
  timeline: [
    {
      ...
      description:
        "Parties signed the software development agreement with milestone delivery dates.",
      evidenceIds: ["ev-1"],
    },
    {
      id: "tl-2",
      ...
      description:
        "Buyer paid the second milestone while reserving concerns about delivery timing.",
      evidenceIds: ["ev-3"],
    },
    {
      id: "tl-3",
      ...
      description:
        "Email chain records a 12-day delay and vendor proposal for phased delivery.",
    ...
    },
    {
      ...
      description:
        "Buyer asserted material breach and requested liquidated damages.",
      evidenceIds: ["ev-6"],
    },
  ],
  issues: [
    ...
    },
    {
      ...
      missingFacts: [
        "Actual loss calculation",
        "Negotiation record for damages clause",
      ],
      humanJudgmentRequired: true,
    },
    {
      ...
      missingFacts: [
        "Loss model",
        "Replacement vendor cost",
        "Internal downtime records",
      ],
    ...
    },
    {
      ...
      missingFacts: [
        "Formal notice before demand letter",
        "Vendor cure response",
      ],
      humanJudgmentRequired: true,
    },
  ],
  evidence: [
    {
      ...
      quote:
        "Vendor shall deliver the production-ready release no later than May 1, 2026.",
      relevance: "direct",
    ...
    },
    {
      ...
      quote:
        "We acknowledge the production release is 12 days behind the agreed delivery date.",
      relevance: "direct",
      supportStatus: "supports",
    },
    {
      ...
      quote:
        "Milestone 2 payment received on April 15; final invoice remains disputed.",
      relevance: "indirect",
      supportStatus: "supports",
    },
    {
      ...
      quote:
        "We can deploy the reporting module first while completing authentication fixes.",
      relevance: "indirect",
    ...
    },
    {
      ...
      quote:
        "Liquidated damages shall equal 30% of total contract value for late delivery.",
      relevance: "direct",
      supportStatus: "supports",
    },
    {
      ...
      section: "Demand",
      quote:
        "Buyer demands immediate payment of liquidated damages for material breach.",
      relevance: "direct",
      supportStatus: "supports",
    },
    {
      ...
      quote:
        "Buyer reserves the right to supplement evidence of business losses.",
      relevance: "weak",
  ...
  reviews: [
    {
      ...
      comment:
        "Damages position should remain framed as risk analysis until actual loss evidence is added.",
    ...
    },
    {
      ...
      comment:
        "The demand letter reserves proof but does not itself prove actual loss.",
      reviewer: "Senior Reviewer",
...
export const complianceObligations: ComplianceObligation[] = [
  ...
  },
  {
    ...
    obligation:
      "Establish deletion request propagation across training data pipeline.",
...
export const dealRedFlags: RedFlag[] = [
  {
    ...
    evidenceIds: ["dd-ev-1"],
    recommendedAction:
      "Request revenue concentration analysis and consent plan.",
  },
  {
    id: "rf-2",
    category: "ip",
    ...
    evidenceIds: ["dd-ev-2"],
    recommendedAction:
      "Add closing deliverable for confirmatory IP assignment.",
  },
  {
    id: "rf-3",
    category: "employment",
    ...
    evidenceIds: ["dd-ev-3"],
    recommendedAction:
      "Request pleadings, settlement posture, and reserve estimate.",
  },
];
