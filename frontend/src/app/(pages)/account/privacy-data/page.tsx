...
export default function PrivacyDataPage() {
    ...
    const handleExportAccountData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "aletheia-account-export.json");
        } catch (error) {
    ...
    const handleExportChatData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "aletheia-chat-export.json");
        } catch (error) {
    ...
    const handleExportTabularReviewsData = async () => {
        ...
        try {
            ...
            downloadBlob(blob, filename ?? "aletheia-tabular-reviews-export.json");
        } catch (error) {
