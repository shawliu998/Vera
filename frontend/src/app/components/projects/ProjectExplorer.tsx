...
export function ProjectExplorer({
    ...
    async function handleDropOnTarget(targetFolderId: string | null, e: React.DragEvent) {
        const docId = e.dataTransfer.getData("application/aletheia-doc");
        const movingFolderId = e.dataTransfer.getData("application/aletheia-folder");
    ...
    function isInternalDrag(e: React.DragEvent): boolean {
        return (
            Array.from(e.dataTransfer.types).includes("application/aletheia-doc") ||
            Array.from(e.dataTransfer.types).includes("application/aletheia-folder")
        );
    }
                    ...
                    return (
                        <li key={`f-${folder.id}`}>
                            <div
                                draggable
                                onDragStart={(e) => {
                                    e.dataTransfer.setData("application/aletheia-folder", folder.id);
                ...
                {childDocs.map((doc) => {
                    ...
                    return (
                        <li
                            ...
                            draggable
                            onDragStart={(e) => {
                                e.dataTransfer.setData("application/aletheia-doc", doc.id);
                                e.dataTransfer.effectAllowed = "move";
                            }}
