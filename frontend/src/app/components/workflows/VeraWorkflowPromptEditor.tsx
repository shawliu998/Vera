 ...
 *
 * Vera retains Mike's TipTap Markdown model, rich/raw editing, formatting
 * controls and table insertion. Only labels and branding are localized.
 */
...
export function VeraWorkflowPromptEditor({
  value,
  onChange,
  readOnly = false,
}: Props) {
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        {rawMode ? (
          <textarea
            ...
            spellCheck={false}
            maxLength={100_000}
            aria-label={t("workflows.promptEditor.rawLabel")}
