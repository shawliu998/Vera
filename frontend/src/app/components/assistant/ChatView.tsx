...
export function ChatView({
    ...
    useEffect(() => {
        // A chat identity change invalidates only the prior chat's dismissed
        // input prompts.
    ...
    useEffect(() => {
        ...
        // Initial DOM measurement uses the same subscribed scroll handler.
        // eslint-disable-next-line react-hooks/set-state-in-effect
        updateScrollButton();
    ...
    useEffect(() => {
        if (messages.length === 0) {
            ...
            // Async chat history starts empty; hide it until its first stable
            // message snapshot is available.
            // eslint-disable-next-line react-hooks/set-state-in-effect
