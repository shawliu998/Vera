...
const COMPATIBILITY_ERROR_MESSAGE_KEYS = {
  ...
  MODEL_RUNTIME_UNAVAILABLE: "errors.modelUnavailable",
  MODEL_PROFILE_UNAVAILABLE: "errors.modelUnavailable",
  MODEL_CONNECTION_FAILED: "errors.modelConnection",
  MODEL_CONNECTION_TEST_FAILED: "errors.modelConnection",
  MODEL_CREDENTIAL_MISSING: "errors.modelCredentialMissing",
  MODEL_CREDENTIAL_INVALID: "errors.modelCredentialInvalid",
  CREDENTIAL_WRITE_UNAVAILABLE: "errors.credentialWriteUnavailable",
  AUTHENTICATION_FAILED: "errors.modelCredentialInvalid",
  ACCESS_DENIED: "errors.forbidden",
  MODEL_UNAVAILABLE: "errors.modelUnavailable",
  TIMEOUT: "errors.modelConnection",
  PROVIDER_UNAVAILABLE: "errors.modelConnection",
  CONFIGURATION_ERROR: "errors.modelConnection",
  CREDENTIAL_UNAVAILABLE: "errors.credentialUnavailable",
