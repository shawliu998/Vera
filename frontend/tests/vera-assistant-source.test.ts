...
const PORTS = [
  ["src/app/(pages)/assistant/page.tsx", "frontend/src/app/(pages)/assistant/page.tsx"],
  ["src/app/(pages)/assistant/chat/[id]/page.tsx", "frontend/src/app/(pages)/assistant/chat/[id]/page.tsx"],
  ["src/app/(pages)/projects/[id]/assistant/page.tsx", "frontend/src/app/(pages)/projects/[id]/assistant/page.tsx"],
  ["src/app/(pages)/projects/[id]/assistant/chat/[chatId]/page.tsx", "frontend/src/app/(pages)/projects/[id]/assistant/chat/[chatId]/page.tsx"],
  ["src/app/components/assistant/InitialView.tsx", "frontend/src/app/components/assistant/InitialView.tsx"],
  ["src/app/components/assistant/ChatView.tsx", "frontend/src/app/components/assistant/ChatView.tsx"],
  ["src/app/components/assistant/ChatInput.tsx", "frontend/src/app/components/assistant/ChatInput.tsx"],
  ["src/app/components/assistant/UserMessage.tsx", "frontend/src/app/components/assistant/UserMessage.tsx"],
  ["src/app/components/assistant/AssistantMessage.tsx", "frontend/src/app/components/assistant/AssistantMessage.tsx"],
  ["src/app/components/assistant/ModelToggle.tsx", "frontend/src/app/components/assistant/ModelToggle.tsx"],
  ["src/app/components/projects/ProjectAssistantTable.tsx", "frontend/src/app/components/projects/ProjectAssistantTable.tsx"],
  ["src/app/contexts/ChatHistoryContext.tsx", "frontend/src/app/contexts/ChatHistoryContext.tsx"],
  ["src/app/hooks/useAssistantChat.ts", "frontend/src/app/hooks/useAssistantChat.ts"],
] as const;
...
test("Assistant UI records exact pinned Mike provenance without copying its brand", () => {
  for (const [relativePath, upstream] of PORTS) {
    ...
    assert.ok(current.includes(upstream), `${relativePath} records ${upstream}`);
  }
...
test("job acceptance, replay and restart routes stay canonical and separate", () => {
  ...
  assert.match(api, /const path = projectId\s*\? `\/projects\/\$\{safeId\(projectId, "project id"\)\}\/chat`\s*: "\/chat"/);
  assert.match(api, /\/assistant\/jobs\/\$\{safeJobId\}\/events/);
  assert.match(api, /\/assistant\/jobs\/\$\{safeId\(jobId, "Assistant job id"\)\}\/cancel/);
...
test("refresh recovery and terminal controls are explicit in the hook", () => {
  ...
  const assistantMessage = source("src/app/components/assistant/AssistantMessage.tsx");
...
test("shell and Project navigation expose real Assistant routes", () => {
  ...
  const assistantChatPage = source("src/app/(pages)/assistant/chat/[id]/page.tsx");
