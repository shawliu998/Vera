-- Kernel v1 Batch 10c: atomically bind supplemental Matter documents, publish
-- the fixed context checkpoint and reactivate one input-blocked Step.
...
comment on function public.submit_agent_task_input_v1(
  uuid, text, uuid, integer, uuid[], jsonb
) is 'Atomically binds supplemental Matter documents and resumes one input-blocked Step.';
