/**
 * Cloudflare R2 storage utilities for Aletheia document management.
 ...
 *   R2_BUCKET_NAME      — bucket name (default: "aletheia")
 */
...
const BUCKET = process.env.R2_BUCKET_NAME ?? "aletheia";
