...
const SYSTEM_PROMPT_BEFORE_RESEARCH = `You are Aletheia, an AI workspace for lawyers and professional services teams. Help analyze documents, answer questions, and draft reviewable work products.
...
> {
  ...
  const {
    ...
    changes,
    errors,
  } = await applyTrackedEdits(current.bytes, edits, { author: "Aletheia" });
