...
The live gold flow remains pending before the Contract workflow can be claimed
complete.
...
1. Run the contract gold workflow through browser review and optional Word
