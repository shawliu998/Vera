...
-> LocalAletheiaRepository (scaffolded)
```
...
The local adapter intentionally fails closed until SQLite/filesystem persistence
and a non-Supabase auth context are implemented.
